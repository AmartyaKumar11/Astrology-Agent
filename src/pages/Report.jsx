...
import { IArrowLeft, IHome, IPrint, ISparkle } from '../components/icons.jsx';
    ...
    <motion.div {...pageTransition} style={{ minHeight: '100vh', background: '#F3F4F6', padding: '28px 0 80px' }}>
      ...
      >
        <div style={{ textAlign: 'center', paddingBottom: 24, borderBottom: '2px solid var(--indigo)' }}>
          ...
          >
            <ISparkle size={12} /> Generated by Vedic Astrology AI Agent · HIL Reviewed
          </div>
          <h1
            style={{
              fontSize: 28,
        ...
        <ReportSection num="1" title="Consultation Summary">
          <div
            style={{
              display: 'grid',
        ...
        <ReportSection num="3" title="Active Dasha Timeline">
          <DashaTimeline c={c} />
        </ReportSection>
        ...
        <ReportSection num="5" title="Life Guidance">
          <motion.div
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ fontSize: 11, color: 'var(--muted)' }}>via {v.planet}</span>
        ...
        <ReportSection num="6" title="Remedy Recommendations">
          <div
            style={{
              padding: 16,
        ...
        <ReportSection num="7" title="Muhurta Suggestions">
        ...
        >
          This report has been generated by the Vedic Astrology AI Agent using Swiss Ephemeris v2.10 with
          Lahiri Ayanamsa, and reviewed by a certified human astrologer where flagged sections required
          oversight. Astrological guidance is offered for reflection and is not a substitute for medical,
          financial, or legal counsel. Practitioners are encouraged to consult qualified professionals
          before acting on predictions of material consequence.
        </div>
      </div>
    </motion.div>
  );
...
function DashaTimeline({ c }) {
  const stages = [
    { name: 'Previous', tone: '#E5E7EB',        label: 'Jupiter MD' },
    { name: 'Current',  tone: 'var(--indigo)',  label: `${c.activeMahadasha} · ${c.activeAntardasha}` },
    { name: 'Next',     tone: '#E5E7EB',        label: 'Mercury MD' },
  ];
  return (
    <div>
      <div
